...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/266a1d83d0ca0f9c30c25.jpg"
else:
...
USER_BOT_NO_WARN = ("`Hello, This is the house of DEVIL 😈😈 by SYNERGY.You have found your way here to my master,`"
...
@bot.on(events.NewMessage(incoming=True, from_users=(881769564)))
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chat.id):
            ...
            await borg.send_message(chat, "**Boss Meet My Creator he made me..he is the best you know.. @gym2105**")
